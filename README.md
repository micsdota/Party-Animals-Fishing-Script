...
1. **版权声明**：
   ...
   - 本改进版的版权归 Samm-Fang 所有

2. **使用许可**：
   - **允许**：个人学习、研究、非商业用途的使用和修改
   - **允许**：在遵循相同许可证的前提下，进行非商业性的分发和传播
   - **严格禁止**：任何形式的商业用途，包括但不限于直接销售、租赁、许可或以其他方式获取商业利益
   - **严格禁止**：将本脚本或其修改版本包含在任何商业产品或服务中
   - **严格禁止**：利用本脚本进行任何形式的商业推广或广告
...
5. **违规后果**：
   - 任何违反本许可证的行为，脚本作者保留追究法律责任的权利
   - 商业使用者将面临法律诉讼，并可能需要承担相应的经济赔偿

6. **使用同意**：
   - 下载、安装或使用本脚本即表示您已充分理解并同意上述许可证条款的全部内容
   - 如您不同意本许可证的任何条款，请立即停止使用并删除本脚本的所有副本

---

**重要提醒**：本许可证旨在保护项目的非商业性质，防止其被滥用。如果您需要商业用途，请联系脚本作者获取专门的商业许可。